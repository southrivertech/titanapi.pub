...
online version: https://learn.microsoft.com/powershell/module/titanapi/get-svrparam
schema: 2.0.0
---
...
### Get (Default)
```
Get-SvrParam -AdminUrl <String> -ServerGuid <String> [-Fields <String>] [-NodeId <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-SvrParam -AdminUrl <String> -InputObject <ITitanApiIdentity> [-Fields <String>] [-NodeId <String>]
 [<CommonParameters>]
```
