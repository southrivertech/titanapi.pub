...
online version: https://docs.microsoft.com/en-us/powershell/module/titanapi/invoke-cloudsvrupdate
schema: 2.0.0
---

# Invoke-CloudSvrUpdate
...
```
Invoke-CloudSvrUpdate -ServerGuid <String> [-CloudFolderList <ISrtApiModelsApiCloudFolderPoco[]>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Cloud
```
Invoke-CloudSvrUpdate -ServerGuid <String> -Body <ISrtApiModelsApiCloudFolderList> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CloudViaIdentity
```
Invoke-CloudSvrUpdate -InputObject <ITitanApiIdentity> -Body <ISrtApiModelsApiCloudFolderList> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CloudViaIdentityExpanded
```
Invoke-CloudSvrUpdate -InputObject <ITitanApiIdentity> [-CloudFolderList <ISrtApiModelsApiCloudFolderPoco[]>]
