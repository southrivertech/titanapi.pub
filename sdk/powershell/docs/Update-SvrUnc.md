...
online version: https://docs.microsoft.com/en-us/powershell/module/titanapi/update-svrunc
schema: 2.0.0
---
...
```
Update-SvrUnc -ServerGuid <String> [-UncParams <ISrtApiModelsApiServerParamsUncPoco[]>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Update
```
Update-SvrUnc -ServerGuid <String> -Body <ISrtApiModelsApiServerUncList> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Update-SvrUnc -InputObject <ITitanApiIdentity> -Body <ISrtApiModelsApiServerUncList> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-SvrUnc -InputObject <ITitanApiIdentity> [-UncParams <ISrtApiModelsApiServerParamsUncPoco[]>] [-Confirm]
