...
online version: https://docs.microsoft.com/en-us/powershell/module/titanapi/new-svrauth
schema: 2.0.0
---
...
```
New-SvrAuth -ServerGuid <String> [-AuthConfig <ISrtApiModelsApiAuthDataPoco>] [-AuthDesc <String>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### Create
```
New-SvrAuth -ServerGuid <String> -Body <ISrtApiModelsApiServerParamsAuthPoco> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentity
```
New-SvrAuth -InputObject <ITitanApiIdentity> -Body <ISrtApiModelsApiServerParamsAuthPoco> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CreateViaIdentityExpanded
```
New-SvrAuth -InputObject <ITitanApiIdentity> [-AuthConfig <ISrtApiModelsApiAuthDataPoco>] [-AuthDesc <String>]
