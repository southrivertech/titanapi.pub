...
online version: https://learn.microsoft.com/powershell/module/titanapi/get-usrparamfiltered
schema: 2.0.0
---
...
### Get (Default)
```
Get-UsrParamFiltered -AdminUrl <String> -AuthGuid <String> -ServerGuid <String> -UserGuid <String>
 [-ByUserName] [-Fields <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-UsrParamFiltered -AdminUrl <String> -InputObject <ITitanApiIdentity> [-ByUserName] [-Fields <String>]
 [<CommonParameters>]
```
