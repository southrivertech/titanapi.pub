...
online version: https://docs.microsoft.com/en-us/powershell/module/titanapi/remove-usrclouddelete
schema: 2.0.0
---
...
```
Remove-UsrCloudDelete -InputObject <ITitanApiIdentity> -Body <ISrtApiModelsApiUserParamsCloudFolderPoco[]>
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Delete
```
Remove-UsrCloudDelete -AuthGuid <String> -ServerGuid <String> -UserGuid <String>
