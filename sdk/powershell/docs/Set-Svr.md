...
online version: https://docs.microsoft.com/en-us/powershell/module/titanapi/set-svr
schema: 2.0.0
---
...
### SetExpanded (Default)
```
Set-Svr -ServerGuid <String> -ServerNodeGuid <String> [-Dav <ISrtApiModelsApiNodeHostPoco>]
...
### Set
```
Set-Svr -ServerGuid <String> -ServerNodeGuid <String> -Body <ISrtApiModelsApiServerParamsNodesPoco> [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### SetViaIdentity
```
Set-Svr -InputObject <ITitanApiIdentity> -Body <ISrtApiModelsApiServerParamsNodesPoco> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SetViaIdentityExpanded
```
Set-Svr -InputObject <ITitanApiIdentity> [-ServerNodeGuid <String>] [-Dav <ISrtApiModelsApiNodeHostPoco>]
 [-DmzList <ISrtApiModelsApiServerParamsDmzPoco[]>] [-Ftp <ISrtApiModelsApiNodeHostPoco>]
 [-Http <ISrtApiModelsApiNodeHostPoco>] [-IcapSvr <ISrtApiModelsApiNodeHostPoco>] [-NodePriority <Int32>]
 [-NodeType <Int32>] [-ServerNodeName <String>] [-SlSvr <ISrtApiModelsApiNodeHostPoco>]
