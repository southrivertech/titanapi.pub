...
online version: https://learn.microsoft.com/powershell/module/titanapi/get-svrparamfiltered
schema: 2.0.0
---
...
### Get (Default)
```
Get-SvrParamFiltered -AdminUrl <String> -ServerGuid <String> [-Fields <String>] [-NodeId <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-SvrParamFiltered -AdminUrl <String> -InputObject <ITitanApiIdentity> [-Fields <String>] [-NodeId <String>]
 [<CommonParameters>]
```
