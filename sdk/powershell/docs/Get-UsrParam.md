...
online version: https://docs.microsoft.com/en-us/powershell/module/titanapi/get-usrparam
schema: 2.0.0
---
...
### Get (Default)
```
Get-UsrParam -AuthGuid <String> -ServerGuid <String> -UserGuid <String> [-ByUserName] [-Fields <String>]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-UsrParam -InputObject <ITitanApiIdentity> [-ByUserName] [-Fields <String>] [<CommonParameters>]
```
