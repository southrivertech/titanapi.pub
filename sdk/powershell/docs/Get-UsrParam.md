...
online version: https://learn.microsoft.com/powershell/module/titanapi/get-usrparam
schema: 2.0.0
---
...
### Get (Default)
```
Get-UsrParam -AdminUrl <String> -AuthGuid <String> -ServerGuid <String> -UserGuid <String> [-ByUserName]
 [-Fields <String>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-UsrParam -AdminUrl <String> -InputObject <ITitanApiIdentity> [-ByUserName] [-Fields <String>]
 [<CommonParameters>]
```
