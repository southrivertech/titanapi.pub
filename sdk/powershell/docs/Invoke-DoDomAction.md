...
online version: https://learn.microsoft.com/powershell/module/titanapi/invoke-dodomaction
schema: 2.0.0
---
...
### DoExpanded (Default)
```
Invoke-DoDomAction -AdminUrl <String> [-AdditionalProperties <Hashtable>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Do
```
Invoke-DoDomAction -AdminUrl <String> -Body <Hashtable> [-Confirm] [-WhatIf] [<CommonParameters>]
```
